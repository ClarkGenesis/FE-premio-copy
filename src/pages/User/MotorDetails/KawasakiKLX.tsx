                        ...
                        <div className="box overflow-hidden main-content-card">
                            <div className="box-body p-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
                                    ...
                                    <Link to="/KawasakiDomi" className="block text-center"
                                        onClick={() => window.scrollTo({ top: 100})}>
                                        <img
                                            src={Kawasaki_domi}
                                            alt="Honda WINNER X"
                                            className="w-50 mx-auto mb-2 rounded-lg border border-black"/>
                                        <p className="text-sm font-medium hover:underline">Kawasaki Dominar 400</p>
                                        <p className="text-gray-600">₱208,900.00</p>
                                    </Link>
                                </div>
                            </div>
                        </div>
