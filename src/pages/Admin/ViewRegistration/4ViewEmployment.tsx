      ...
      <div className="main-content">
        <div className="container-fluid">
          <Breadcrumb
            ...
            links={[{ text: "Parental & Credit Information", link: "/3ViewParental" }]}
            active="Employment & Payment Details Form"/>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-5 md:grid-cols-4 gap-2">
                        {[
                          [
                            "Applicant's Employer/Business Name/Business Type",
                            "applicantEmployer",
                            "bi bi-person-circle",
                          ],
                      ...
                      <div className="grid grid-cols-5 md:grid-cols-2 gap-2">
                        {[
                          [
                            "Spouse Employer/Business Name/Business Type",
                            "spouseEmployer",
                            "bi bi-person-circle",
                          ],
                    ...
                    <div className="border border-gray-400 p-4 rounded-sm w-1/2">
                      <div className="flex flex-wrap gap-4">
                        {[
                          ...
                          <div
                            key={value}
                            className="flex items-center border border-gray-400 rounded-md px-4 py-2 hover:bg-gray-300 cursor-pointer"
                          >
                            <input
                              type="checkbox"
                              id={value}
