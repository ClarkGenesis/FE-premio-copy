                ...
                <div className='main-sidebar' id="sidebar-scroll">
                    <nav className="main-menu-container nav nav-pills flex-col sub-open ">
                        ...
                        <ul className='main-menu pt-5'>
                            ...
                            <li className='slide'>
                                <Link to="/user" className="side-menu__item flex items-center gap-2 px-4 py-3 rounded-lg bg-gray-200 hover:bg-green-700 transition duration-300 ease-in-out shadow-md">
                            ...
                            <li className='slide'>
                                <Link to="/Motorcycles" className="side-menu__item flex items-center gap-2 px-4 py-3 rounded-lg bg-gray-200 hover:bg-green-300 transition duration-300 ease-in-out shadow-md">
                            ...
                            <div className='p-2'></div>
                            <li className='slide'>
                                <Link to="/MyPre-Registrations" className="side-menu__item flex items-center gap-2 px-4 py-3 rounded-lg bg-gray-200 hover:bg-green-700 transition duration-300 ease-in-out shadow-md">
